...
import rkaniecki.spring5recipeapp.services.ImageService;
...
public class ImageController {
    ...
    public String postImageToDatabase(@PathVariable Long recipeId, @RequestParam("imagefile") MultipartFile file) {
